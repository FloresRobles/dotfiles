...
sudo scutil --set ComputerName "0x6A6176696572"
sudo scutil --set HostName "0x6A6176696572"
sudo scutil --set LocalHostName "0x6A6176696572"
sudo defaults write /Library/Preferences/SystemConfiguration/com.apple.smb.server NetBIOSName -string "0x6A6176696572"
...
###############################################################################
# Mouse: speed and two right button and two fingers swipe for navigation
...
defaults write com.apple.dock persistent-apps -array \
	"Finder" "XCode" "Atom" "Terminal" "Mail" "Safari"
...
for app in "Activity Monitor" "Address Book" "Calendar" "Contacts" "cfprefsd" \
	...
	"Photos" "Safari" "Spectacle" "SystemUIServer" "Transmission"	"Twitter" \
	"iCal"; do
