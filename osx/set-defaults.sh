...
sudo scutil --set ComputerName "Javier"
sudo scutil --set HostName "Javier"
sudo scutil --set LocalHostName "Javier"
sudo defaults write /Library/Preferences/SystemConfiguration/com.apple.smb.server NetBIOSName -string "Javier"
